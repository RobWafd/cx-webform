  ...
  return (
    <PageLayout>
      <div className="flex flex-col max-w-3xl mx-auto w-full pt-8">
        <h2 className="text-[24px] leading-[28px] font-semibold text-wafd-green mb-6 text-center md:text-left">Access your Rewards</h2>
        ...
        <ul className="list-[circle] pl-4 text-lg text-wafd-text mb-10 leading-relaxed space-y-6">
          <li className="mb-3">
            ...
            <ol className="list-decimal pl-6 mt-1 text-wafd-text text-[16px] leading-[24px] space-y-2">
              <li>Login</li>
